package com.cgbsoft.lib.encrypt;
...
public final class RSAUtils {
	...
	private static String RSA = "RSA";// "RSA/ECB/PKCS1Padding";RSA/ECB/PKCS1Padding
	private static String RSA1 = "RSA/ECB/PKCS1Padding";

	// public static String ReRsa(Context x, String Rsas) {
	// try {
	// // 从字符串中得到私钥
	// // PrivateKey privateKey = RSAUtils.loadPrivateKey(PRIVATE_KEY);
	// // 从文件中得到私钥
	// InputStream inPrivate = x.getResources().getAssets()
	// .open("rsa_private_key.pem");
	// PrivateKey privateKey = RSAUtils.loadPrivateKey(inPrivate);
	// // 因为RSA加密后的内容经Base64再加密转换了一下，所以先Base64解密回来再给RSA解密
	// byte[] decryptByte = RSAUtils.decryptData(Base64Utils.decode(Rsas),
	// privateKey);
	...
	// }
	/**
	 * 加密 TODO当前RSA加密是测试的key文件
	 */
	public static String GetRsA(Context x, String source,String publicky) throws Exception {
		// 从字符串中得到公钥
...
//			publicKey = RSAUtils.loadPublicKey(inPublic);
	...
	public static PublicKey loadPublicKesssy(String in) throws Exception {
		try {
