...
//    }
    ...
    private String getCrashReport(Context context, Throwable ex) {
        PackageInfo pinfo = ((BaseApplication) context.getApplicationContext())
                .getPackageInfo();
     ...
     * @param crashReport
     */
    private void sendAppCrashReport(final Context cont, final String crashReport) {
...
//						AppManager.getAppManager().AppExit(cont);
                        // 重启App
                        Intent i1 = cont.getPackageManager()
                                .getLaunchIntentForPackage(cont.getPackageName());
...
//                        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
     ...
     * 发送App异常崩溃报告(发送邮件)
     */
    private void sendAppCrashReport1(final Context cont,
                                     final String crashReport) {
//        DefaultDialog defaultDialog=new DefaultDialog(cont,cont.getString(R.string.app_error_message),cont.getString(R.string.cancel_str),R.string.submit_report) {
//            @Override
//            public void left() {
//
//            }
...
//        Dialog MyDialog = new Dialog(cont, R.style.mystyle);
//        View MyView = LayoutInflater.from(cont).inflate(R.layout.activity_load,
//                null);
...
//                        i.putExtra(Intent.EXTRA_EMAIL,
//                                new String[]{"beist@sohu.com"});
//                        i.putExtra(Intent.EXTRA_SUBJECT, "33客户端 - 错误报告");
//                        i.putExtra(Intent.EXTRA_TEXT, crashReport);
//                        cont.startActivity(Intent.createChooser(i, "发送错误报告"));
//                        // 退出
////                        AppManager.getAppManager().AppExit(cont);
