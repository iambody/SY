...
public class CurLiveInfo {
    ...
    public static String getShareUrl() {
        try {
            return String.format("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx1622f3ec2d611b59&redirect_uri=%s&response_type=code&scope=snsapi_login&state=00000#wechat_redirect",
                    URLEncoder.encode(
                            String.format(
                                    "%s?userId=%s&roomId=%d",
