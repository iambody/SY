...
/**
 * desc
 * Created by yangzonghui on 2017/5/25 12:13
...
//	public static final String UID_TYPE = "884";
    ...
    public static final String ACTION_LIVE_SEND_ID = "ACTION_LIVE_SEND_ID";
    public static final String ACTION_LIVE_RECEVER_MSG = "ACTION_LIVE_RECEVER_MSG";
    ...
    public static final String QAV_EVENT_ID_ENDPOINT_NO_SCREEN_VIDEO = PACKAGE + "QAV_EVENT_ID_ENDPOINT_NO_SCREEN_VIDEO";

    public static final String QAV_EVENT_ID_ENDPOINT_HAS_SCREEN_VIDEO = PACKAGE + "QAV_EVENT_ID_ENDPOINT_HAS_SCREEN_VIDEO";
    ...
    public static final String ACTION_EXIT_ROOM_DISNOR = PACKAGE + ".ACTION_EXIT_ROOM_DISNOR";
    public static final String ACTION_EXIT_ROOM_PARAMS = "pa";
    ...
    public static final String EXTRA_ALLOW_CHAT = "allow_chat";
    ...
    public static final String ACTION_JOIN_LIVE_SERVICE = "ACTION_JOIN_LIVE_SERVICE";
    ...
    public static final String LIVE_STATUS_OK = "LIVE_STATUS_OK";
