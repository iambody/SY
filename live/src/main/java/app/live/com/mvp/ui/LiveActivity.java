...
import app.live.com.mvp.model.ChatEntity;
...
import app.live.com.mvp.presenter.GetLinkSignHelper;
import app.live.com.mvp.presenter.LiveHelper;
import app.live.com.mvp.presenter.LiveListViewHelper;
import app.live.com.mvp.presenter.LivePresenter;
import app.live.com.mvp.presenter.UserServerHelper;
import app.live.com.mvp.presenter.viewinface.GetLinkSigView;
import app.live.com.mvp.presenter.viewinface.LiveListView;
import app.live.com.mvp.presenter.viewinface.LiveView;
import app.live.com.mvp.presenter.viewinface.ProfileView;
import app.live.com.utils.Constants;
import app.live.com.utils.LogConstants;
import app.live.com.utils.SxbLog;
import app.live.com.utils.UIUtils;
import app.privatefund.com.live.R;

/**
 * Live直播类
 */
public class LiveActivity extends BaseActivity<LivePresenter> implements LiveContract.view, LiveView, View.OnClickListener, ProfileView, LiveListView, GetLinkSigView {
...
//        }
    ...
    private void initView() {
        ...
        view1 = (RelativeLayout) inflater.inflate(R.layout.live_page_layout1, null);
        view2 = (RelativeLayout) inflater.inflate(R.layout.live_page_layout2, null);
        ImageButton close2 = (ImageButton) view2.findViewById(R.id.close2);
        close2.setOnClickListener(this);
        viewList.add(view1);
        viewList.add(view2);

        mHostCtrView = (LinearLayout) view1.findViewById(R.id.host_bottom_layout);
        mCtrViewMore = (LinearLayout) view1.findViewById(R.id.host_bottom_layout_more);
        mNomalMemberCtrView = (LinearLayout) view1.findViewById(R.id.member_bottom_layout);
...
//                showReportDialog();
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.host_message_input || i == R.id.member_message_input || i == R.id.vmember_message_input) {
            inputMsgDialog();

        } else if (i == R.id.member_send_good || i == R.id.vmember_send_good) {//                mHeartLayout.addFavor();
            if (checkInterval()) {
        ...
        } else if (i == R.id.host_switch_cam || i == R.id.vmember_switch_cam) {
            ILiveRoomManager.getInstance().enableCamera(1 - ILiveRoomManager.getInstance().getCurCameraId(), true);

        } else if (i == R.id.host_mic_btn || i == R.id.vmember_mic_btn) {
...
//                BtnMic.setBackgroundResource(R.drawable.icon_mic_open);
        ...
        } else if (i == R.id.vmember_close_member_video) {
            cancelMemberView(backGroundId);

        } else if (i == R.id.host_beauty_btn || i == R.id.vmember_beauty_btn) {
        ...
        } else if (i == R.id.host_menu_more || i == R.id.member_menu_more || i == R.id.vmember_menu_more) {
        ...
        } else if (i == R.id.host_fullscreen_btn || i == R.id.member_fullscreen_btn || i == R.id.vmember_fullscreen_btn) {
            bCleanMode = true;
            mFullControllerUi.setVisibility(View.INVISIBLE);
        ...
        } else if (i == R.id.link_btn) {
//            showLinkDialog();

        } else if (i == R.id.unlink_btn) {
