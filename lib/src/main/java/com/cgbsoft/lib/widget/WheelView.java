...
public class WheelView extends View {
     ...
     * 选择字体大小
     */
    private static int TEXT_SELECT_SIZE = 18;
    ...
    private void initData(Context context) {
        ADDITIONAL_ITEM_HEIGHT = (int) context.getResources().getDimension(R.dimen.activity_horizontal_margin);
        TEXT_SIZE = (int) context.getResources().getDimension(R.dimen.dimens_sp_14);
        TEXT_SELECT_SIZE = (int) context.getResources().getDimension(R.dimen.dimens_sp_14);
    ...
    private void initResourcesIfNecessary() {
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setShadowLayer(5f, 0, 0.1f, 0xFFC0C0C0);
        }
...
//		setBackgroundResource(R.drawable.wheel_bg);
    ...
    private int getItemHeight() {
        ...
        return getHeight() / visibleItems+10;
    }
    ...
    private void drawShadows(Canvas canvas) {
        topShadow.setBounds(0, 0, 0, 0);
        topShadow.draw(canvas);

        bottomShadow.setBounds(0, 0,
                0, 0);
...
//		valuePaint.setColor(VALUE_TEXT_COLOR);
        ...
        valuePaint.setTextSize(TEXT_SELECT_SIZE);
...
//		itemsPaint.setColor(ITEMS_TEXT_COLOR);
        itemsPaint.setColor(Color.parseColor("#878787"));
...
//            scroller.fling(0, lastScrollY, 0, (int) -velocityY / 2, 0, 0, minY, maxY);
            scroller.fling(0, lastScrollY, 0, 0, 0, 0, minY, maxY);//临时修改，非正宗
