...
public class GestureImageView extends ImageView {
   ...
   * and ScaleType.
   */
  public void setZoom(GestureImageView img) {
   ...
   */
  private int setViewSize(int mode, int size, int drawableDimen) {
    int viewSize;
    switch (mode) {
      ...
      case MeasureSpec.AT_MOST:
        viewSize = Math.min(drawableDimen, size);
        break;

      case MeasureSpec.UNSPECIFIED:
        viewSize = drawableDimen;
        break;
