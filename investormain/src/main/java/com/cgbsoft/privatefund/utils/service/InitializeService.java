...
public class InitializeService extends IntentService {
    private final String TAG = "InitializeService";
...
//        initX5();//初始化x5内核
   //     initMob();//初始化友盟统计
    ...
    private void initIm() {
         ...
         * io.rong.push 为融云 push 进程名称，不可修改。 // "io.rong.push".equals(DeviceUtils.getCurProcessName(getApplicationContext()))
         */
