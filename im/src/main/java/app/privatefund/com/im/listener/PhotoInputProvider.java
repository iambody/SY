...
//        NavigationUtils.startSystemImageForResult((Activity) mContext.getBaseContext(), REQUEST_IMAGE);
//    }
//
//    @Override
...
//            mQueueSize = 0;
//            ArrayList<String> uris = data.getStringArrayListExtra(ImageSelector.EXTRA_RESULT);
...
//                if (item.endsWith("1")) {
//                    al.add(new PictureState(item.substring(0, item.length() - 1), true));
//                } else {
//                    if (item.endsWith("0")) {
//                        al.add(new PictureState(item.substring(0, item.length() - 1), false));
//                    } else {
...
//
//        }
//// else if(requestCode == REQUEST_IMAGE && resultCode == -2){
////            ArrayList<String> uris = data.getStringArrayListExtra(MultiImageSelectorActivity.EXTRA_RESULT);
////
////            Intent intent = new Intent(MApplication.mContext, PreviewActivity.class);
...
//        public void run() {
//
//            RLog.d("AttachRunnable", "insert image and save to db, uri = " + mUri);
...
//                                RLog.d("AttachRunnable", "onSuccess insert image");
...
//                                RLog.d("AttachRunnable", "onError insert image, error = " + e);
//                            }
//                        });
//            }
//        }
