...
public class FloatingActionMenu {
    ...
    public View getActivityContentView() {
        return ((Activity)getActivityFromView(mainActionView)).getWindow().getDecorView().findViewById(16908290);
    }

    private Point getScreenSize() {
        Point size = new Point();
        ((Activity)getActivityFromView(mainActionView)).getWindowManager().getDefaultDisplay().getSize(size);
        return size;
    }
