...
public class LineBreakLayout extends ViewGroup {
    ...
    private OnClickFlagText onClickFlagText;

    public interface OnClickFlagText {
    ...
    public void setOnClickFlagText(OnClickFlagText onClickFlagText) {
        this.onClickFlagText = onClickFlagText;
    }
            ...
            for (final String lable : lables) {
                ...
                tv.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (onClickFlagText != null) {
                            onClickFlagText.onclick(((TextView)v).getText().toString());
                        }
