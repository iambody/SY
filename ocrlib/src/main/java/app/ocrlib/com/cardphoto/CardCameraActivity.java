...
public class CardCameraActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener{
    ...
    private void initData() {
        ...
        margin = CameraSystemUtils.dp2px(this, 20);
    ...
    private void captrue() {
        mCamera.takePicture(null, null, new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                CameraBitmapUtils.saveJPGE_After(context, saveBitmap, img_path, 100);

                Log.i(TAG, "img_path:" + img_path);

                //返回
                Intent intent = new Intent();
                intent.putExtra(CameraConstants.IntentKeyFilePath, img_path);
                setResult(CameraConstants.IntentResultCode, intent);
                finish();
